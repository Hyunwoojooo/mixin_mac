class ServiceTermText {
  String first = '에브리타임 서비스 이용약관은 스위치온 주식회사(이하 “회사”라 합니다)가 제공하는 에브리타임 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.';
  ...
  String third = '1. 회사는 이 약관을 서비스 초기화면, 회원가입 화면 및 “내 정보” 메뉴 등에 게시하거나 기타의 방법으로 회원에게 공지합니다.\n'
      '2. 회사는 필요하다고 인정되는 경우, 관련법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.\n'
      '3. 회사는 약관을 개정할 경우, 적용 일자 및 개정 사요를 명시하여 현행약관과 함께 개정약관 적용 일자 7일 전부터 “공지사항”을 통해 공지합니다. 다만, 개정 내용이 회원의 권리 및 의무에 중대한 영향을 미치는 경우에는 적용 일자 30일 전부터 회원의 연락처 또는 서비스 내부 알림 수단으로 개별 공지합니다.\n'
      '4. 회원은 개정 약관에 동의하지 않을 경우, 제7조(서비스 이용계약의 종료)에 따른 회원 탈퇴 방법으로 거부 의사를 표시할 수 있습니다. 단, 회사가 약관개정 시 “개정 약관의 적용 일자까지 회원이 거부 의사를 표시하지 아니할 경우 약관의 개정에 동의한 것으로 간주한다”는 내용을 고지하였음에도 불구하고 회원이 약관 개정에 대한 거부 의사를 표시하지 아니하면, 회사는 적용 일자부로 개정 약관에 동의한 것으로 간주합니다.\n'
  ...
  String fourth = '1. 회사는 다음 서비스를 제공합니다.\n'
      '· 대학교별 폐쇄형 커뮤니티 서비스\n'
      '· 대학, 문화, 활동, 취업 정보 제공 서비스\n'
      '· 할인, 이벤트, 프로모션, 광고 정보 제공 서비스\n'
      '· 다른 회사 및 단체와의 제휴나 협력을 통해 제공하는 서비스\n'
      '· 다른 회사 및 단체와의 제휴나 협력을 통해 제공하는 서비스\n'
      '· 기타 회사가 정하는 서비스\n'
      '2. 믹스인은 학생증, 학교 웹메일, 증명서 등을 통해 해당 대학교의 학부재학생 및 졸업생 또는 해당연도 입학생으로 인증받은 이용자에 한해 커뮤니티를 이용할 수 있는 폐쇄형 서비스입니다. 믹스인은 대학교별로 개별 운영되므로, 학교 인증을 받지 않은 이용자 및 불특정 다수의 일반 이용자는 커뮤니티를 포함한 대부분의 기능에 접근할 수 없습니다.\n'
      '3. 회사는 운영상, 기술상의 필요에 따라 제공하고 있는 서비스를 변결할 수 있습니다.\n'
  ...
  String fifth = '1. 회사외 회원의 서비스 이용계약은 서비스를 이용하고자 하는 자(이하 “가입 신청자”라고 합니다)가 서비스 내부의 회원가입 양식에 따라 필요한 회원정보를 기입하고, 이 약관, 개인정보 수집 및 이용 동의, 커뮤니티 이용규칙 등에 명시적인 동의를 한 후, 신청한 회원가입 의사 표시(이하 “이용신청”이라 합니다)를 회사가 승낙함으로써 체결됩니다.\n'      '2. 제1항의 승낙은 신청순서에 따라 순차적으로 처리되며, 회원가입의 성립기는 회사의 회원가입이 완료되었음을 알리는 승낙의 통지가 회원에게 도달하거나, 이에 준하는 권한이 회원에게 부여되는 시점으로 합니다.'
  ...
  String sixth = '1. 회사는 관계 법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 이용에 관해서는 관련 법령 및 회사의 개인정보 처리방침을 따릅니다.\n'
      '2. 회원은 개인정보에 변동이 있을 경우, 즉시 “내 정보” 메뉴 및 문의 창구를 이용하여 정보를 최신화해야 합니다.\n'
      '3. 회원의 아이디, 비밀번호, 이메일, 대학생 정보 등 모든 개인정보의 관리책임은 본인에게 있으므로, 타인에게 양도 및 대여할 수 없으며 유출되지 않도록 관리해야 합니다. 만약 본인의 아이디 및 비밀번호를 타인이 사용하고 있음을 인지했을 경우, 즉시 문의창구로 알려야 하고, 안내가 있는 경우 이에 따라야 합니다.\n'
      '4. 회사는 회원이 제2항과 제3항을 이행하지 않아 발생한 피해에 대해, 회사의 고의 또는 중대한 과실이 없는 한 어떠한 책임도 지지 않습니다.';

  String seventh = '1. 회원은 언제든지 본인의 계정으로 로그인한 뒤 서비스 내부의 “탈퇴하기”버튼을 누르는 방법으로 탈퇴를 요청할 수 있으며, 그 외 문의 창구 등을 통한 탈퇴 요청은 처리되지 않습니다. 회사는 해당 요청을 확인한 후 탈퇴를 처리합니다.\n'
      '2. 회원은 관리하고 있는 커뮤니티가 있을 경우, 이를 양도하거나 삭제하기 전까지 탈퇴할 수 없습니다.\n'
  ...
  String eighth = '1. 회사가 회원에 대한 통지가 필요한 경우, 회원의 연락처 또는 서비스 내부 알림 수단을 이용할 수 있습니다.\n'
  ...
  String ninth = '1. 회사는 유용하고 편리한 서비스를 제공하기 위해, 2009년부터 서비스 및 서비스 내부의 기능의 체계와 다양한 기능을 직접 설계 및 운영하고 있는 데이터베이스 제작자에 해당합니다. 회사는 저작권법에 따라 데이터베이스 제작자는 복제권 및 전송권을 포함한 데이터베이스 전부에 대한 권리를 가지고 있으며, 이는 법률에 따라 보호를 받는 대상입니다. 그러므로 이용자는 데이터베이스 제작자인 회사의 승인 없이 데이터베이스의 전부 또는 일부를 복제/배포/방송 또는 전송할 수 없습니다.\n'
  ...
  String tenth = '1. 누구든지 게시물로 인해 사생활 침해나 명예훼손 등 권리가 침해된 경우 회사에 해당 게시물의 삭제 또는 반박내용의 게재를 요청할 수 있습니다. 이때 회사는 해당 게시물을 삭제할 수 있으며, 만약 권리 침해 여부가 불분명하거나 당사자 간 다툼이 예상되 경우에는 해당 게시물에 대한 접근을 30일간 임시적으로 차단하는 조치를 취할 수 있습니다.\n'
  ...
  String eleventh = '1. 회사는 서비스 제공을 위해 서비스 내부에 광고를 게재할 수 있습니다.\n'
  ...
  String twelfth = '1. 이용자는 다음과 같은 행위를 해서는 안됩니다.\n'
      '· 성적 도의관념에 반하는 행위\n'
      ...
      '· 홍보/판매 행위\n'
      '· 이 약관이 적용되는 서비스 및 기능과 동일하거나 유사한 서비스 및 기능에 대한 직간접적 홍보 행위\n'
      '· 서비스, 브랜드, 사이트, 애플리케이션, 사업체, 단체 등을 알리거나 가입, 방문을 유도하기 위한 직간접적 홍보 행위\n'
      '· 계정 판매 및 공유, 대리 게시, 서포터즈 등을 통해 여러 학교에 다발적으로 게시되는 동일한 주제에 대한 직간접적인 홍보 행위\n'
      ...
      '· 프로그램, 스크립트, 봇을 이요안 서비스 접근 등 사람이 아닌 컴퓨팅 시스템을 통한 서비스 접근 행위\n'
      '· API 직접 호출, 유저 에이전트 조작, 패킷 캡처, 비정상적인 반복 조회 및 요청 등 허가하지 않은 방식의 서비스 이용 행위\n'
      '· 회사의 모든 재산에 대한 침해 행위\n'
      '· 업무 방해 행위\n'
      '· 서비스 관리자 또는 이에 준하는 자격을 허가 없이 취득하여 권하을 행사하거나, 사칭하여 허위의 정보를 발설하는 행위\n'
  ...
  String thirteenth = '1. 이용자가 이 약관 및 커뮤니티 이용규칙에서 이 조항 적용이 명시된 금지행위 및 이에 준하는 행위를 할 경우, 회사는 서비스 보호를 위해 다음과 같은 조치를 최대 영구적으로 취할 수 있습니다. 해당 조치는 서비스 보호를 위해 불가피하다고 판단될 경우, 회사가 제공하는 모든 서비스의 동일인으로 확인되는 모든 계정에 일괄적으로 적용될 수 있습니다.\n'
  ...
  String fourteenth = '1. 회사와 이용자 간에 발생한 분쟁에 관한 소송은 민사소송법상의 관할 법윈에 제소합니다.\n'
      '2. 회사와 이용자 간에 제기된 소송에는 대한민국 법을 준거법으로 합니다.';

  String fifteenth = '1. 이 약관은 2022년 6월 14일에 개정되었습니다.\n'
      ...
      '4. 이 약관에 정하지 아니한 사항과 이 약관의 해석에 관하여는 관련법 또는 관례에 따릅니다.';
}